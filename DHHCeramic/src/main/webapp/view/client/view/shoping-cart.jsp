                    ...
                    <table>
                        ...
                        <tr>
                            <td class="shoping__cart__item">
                                <img src="${url}/img/cart/cart1.jpg" alt="">
                                <h5>Gạch lát nền Prime</h5>
                            </td>
                        ...
                        <tr>
                            <td class="shoping__cart__item">
                                <img src="${url}/img/cart/cart2.jpg" alt="">
                                <h5>Gạch lát sân thượng</h5>
                            </td>
                            <td class="shoping__cart__price">
                                45.000 VND
                            </td>
                        ...
                        <tr>
                            <td class="shoping__cart__item">
                                <img src="${url}/img/cart/cart3.jpg" alt="">
                                <h5>Gạch ốp tường MỸ Ý</h5>
                            </td>
                            <td class="shoping__cart__price">
                                140.000 VND
                            </td>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="shoping__cart__btns">
                    <a href="${pageContext.request.contextPath}/view/client/view/shop-grid.jsp" class="primary-btn cart-btn">Tiếp tục mua sắm</a>
            ...
            <div class="col-lg-6">
                <div class="shoping__checkout">
                    ...
                    <ul>
                        <li>Tổng phụ<span>450.000 VND</span></li>
                        <li>Tổng cộng <span>450.000 VND</span></li>
                    </ul>
                    <a href="${pageContext.request.contextPath}/view/client/view/checkout.jsp" class="primary-btn">TIẾN HÀNH THANH TOÁN</a>
                </div>
            </div>
        </div>
    </div>
