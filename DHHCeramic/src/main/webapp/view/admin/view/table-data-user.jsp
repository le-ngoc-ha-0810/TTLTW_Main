        ...
        <div class="tile-body">
          ...
          <div class="row element-button">
            <div class="col-sm-2">
              ...
              <a class="btn btn-add btn-sm" href="${pageContext.request.contextPath}/view/client/view/form-add-user.jsp" title="Thêm"><i class="fas fa-plus"></i>
          ...
          <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
            ...
            <tr>
              ...
              <td>#12</td>
              <td>Trần Khả Ái</td>
              <td><img class="img-card-person" src="${url}/img-anhthe/2.jpg" alt=""></td>
