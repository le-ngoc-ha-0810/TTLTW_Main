            ...
            <div class="tile-body">
              <div class="row element-button">
                <div class="col-sm-2">
                  ...
                  <a class="btn btn-add btn-sm" href="${pageContext.request.contextPath}/view/client/view/form-add-don-hang.jsp" title="Thêm"><i class="fas fa-plus"></i>
                    Tạo mới đơn hàng</a>
                </div>
                <div class="col-sm-2">
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Gạch ốp tường Mỹ Ý, Gạch ốp vỉa hè xám 002</td>
                    <td>50x90 cm</td>
                    <td>2,5</td>
                    <td>9.400.000 VND</td>
                  ...
                  <tr>
                    ...
                    <td>3947</td>
                    <td>Phạm Thị Ngọc</td>
                    <td>Gạch lát cầu thang sọc trắng xịn</td>
                    <td>60x90 cm</td>
                    <td>20</td>
                    <td>19.770.000 VND</td>
                    <td><span class="badge bg-info">Đang giao hàng</span></td>
                  </tr>
                  <tr>
                    <td width="10"><input type="checkbox" name="check1" value="1"></td>
                    <td>8723</td>
                    <td>Ngô Thái An</td>
                    <td>Gạch kính lấy sáng trắng MY</td>
                    <td>50x90 cm</td>
                    <td>4</td>
                    <td>400.000 VND</td>
